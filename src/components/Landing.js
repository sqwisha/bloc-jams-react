  ...
  <LandingContainer>
    ...
    <SellingPoints>
      <div className="point">
        ...
        <PointDescription>The world is full of music; why should you have to listen to music that someone else chose?</PointDescription>
      </div>
      <div className="point">
        <PointTitle>Unlimited, streaming, ad-free</PointTitle>
        <PointDescription>No arbitrary limits. No distractions.</PointDescription>
      </div>
      <div className="point">
        <PointTitle>Mobile enabled</PointTitle>
        <PointDescription>Listen to your music on the go. This streaming service is available on all mobile platforms.</PointDescription>
      </div>
